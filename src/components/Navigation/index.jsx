    ...
    return (
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="container-fluid justify-content-end">
                    <Nav.Link eventKey="1" className={`${navSelected === "home" && "active"}`} onClick={() => setNavSelected("home")}>Home</Nav.Link>
                    <Nav.Link eventKey="1" onClick={() => setNavSelected("about")}>About</Nav.Link>
                    <Nav.Link eventKey="1" onClick={() => setNavSelected("portfolio")}>Portfolio</Nav.Link>
